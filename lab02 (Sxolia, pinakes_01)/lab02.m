...
% % orizontai apo thn akolou8ia tou Fibonacci. Dhladh y(1) = 1, y(2)=1,y(n+2)=y(n)+y(n+1).
y(1) = 1
y(2) = 1
for k=3:20
   y(k) = y(k-1)+y(k-2);
...
% % ASKHSH 4
% % Grapste mia synarthsh me onoma myfun , orisma eisodoy ena akeraio m kai
% % orisma epistrofhs enan pragmatiko ari8mo s, s = myfun(m).
% % H synarthsh 8a ypologizei to a8roisma twn m prwtwn orwn ths akoloy8ias
% % Fibonacci.
%  
% sum15 = myfun(15);
