...
%% path(path,'FULL_PATH_TO_LAB03\drawLA')
...
% drawVector(......       % Plot the vectors
% drawLine(....., 'r3');              % Draw a line between them
% view(15,5);
% pause;
% view(60,10);
% hold off;
...
%% ASKHSH 4
%% Xrhsimopoihste tis synarthseis tic kai toc toy matlab gia na xronometrhsete 
