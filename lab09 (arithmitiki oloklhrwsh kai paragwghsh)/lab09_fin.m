...
%% Oloklhrwste th synarthsh 1 metablhths f(x) = 1./sqrt(1+x.^4)

clc; clear all, disp('ASKHSH 1')
ekf1 = '1./sqrt(1+x.^4)';
f1 = inline(ekf1);
ezplot(f1, [-2, 2]);
olok1 = quad(f1, -2, 2);
...
subplot(2,1,2)
loglog([11:10:1001], error, 'b',[11:10:1001],([11:10:1001]-1).^(-2) ,'m')
xlabel('# shmeiwn diakritopoihshs')
